...
public class CLOSE_RED_6_BALL extends OpMode {
        ...
        switch (pathState) {
            ...
            case shoot_preload:
                if (!follower.isBusy()) {
                    ...
                    // Stop transfer if ball detected while waiting for shooter
            ...
            case drive_shootPOS_pickUp1POS:
                if (!follower.isBusy()) {
                    intake.setPower(1.0);
                    transfer.setPower(ballInTransfer ? 0.0 : 0.6); // Added sensor check
            ...
            case drive_pickUp1EndPOS_shootPOS:
                // Maintain indexing while driving back
                intake.setPower(1.0);
                transfer.setPower(ballInTransfer ? 0.0 : 0.6);
    ...
    public void loop() {
        ...
        // Update sensor state: User confirmed True = Ball Detected
