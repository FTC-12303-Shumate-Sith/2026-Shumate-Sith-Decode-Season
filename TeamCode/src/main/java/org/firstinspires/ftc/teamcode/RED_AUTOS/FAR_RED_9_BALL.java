...
public class FAR_RED_9_BALL extends OpMode {
    ...
    private final Pose shootPose = new Pose(84,82, Math.toRadians(46));
    ...
    public void start() {
        ...
        // Ensure hood is up for auto shots
        shooterSub.setHood(1.0);
    }

    public void loop() {
        follower.update();
        ballInTransfer = stopSensor.getState(); // Update sensor state
        shooterSub.update(0, false); // Heartbeat for PID logic
